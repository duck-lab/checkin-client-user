      ...
      <div className="page home">
        <header>
          ...
          <div className="hero-subunit">
            <h4>
              A simple starting point for React with routing, data-fetching and state
              management!
            </h4>
          </div>
        ...
        <main>
          ...
          <div className="boilerplate-item">
            ...
            <div className="boilerplate-item-content">
              ...
              <p>
                React Router is a declarative way to render, at any location, any UI that you
                and your team can think up.
              </p>
            </div>
          </div>
          <div className="boilerplate-item">
